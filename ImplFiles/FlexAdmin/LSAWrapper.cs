// Taken from: http://stackoverflow.com/questions/10187837/granting-seservicelogonright-to-a-user-from-powershell
...
namespace MyLsaWrapper
{
  ...
  public class LsaWrapperCaller
  {
    ...
    {
      //Console.WriteLine("[debug] AddPrivileges: {0} {1}", account, privilege);
